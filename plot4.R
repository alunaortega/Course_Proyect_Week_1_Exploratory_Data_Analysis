...
plot(y = hpc$Global_active_power, x = hpc$Date_Time, type = "l", xlab = "", ylab = "Global Active Power")
plot(y = hpc$Voltage, x = hpc$Date_Time, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(y = hpc$Global_reactive_power, x = hpc$Date_Time, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
rm(hpc)